...
s = {'HA1': {
    'H2': ['1D', '2Q', '3I', '4C', '5I', '6G', '7Y', '8H', '9-', '10N', '11N', '12S', '13T', '14-', '15K', '16V', '17D',
           '18T', '19I', '20L', '21E', '22R', '23N', '24V', '25T', '26V', '27T', '28H', '29A', '30-', '31D', '32I',
           '33L', '34E', '35K', '36T', '37H', '38N', '39G', '40K', '41L', '42C', '43K', '44L', '45N', '46G', '47I',
           '48P', '49P', '50L', '51E', '52L', '53G', '54D', '55C', '56S', '57I', '58A', '59G', '60W', '61L', '62L',
           '63G', '64N', '65P', '66E', '67C', '68D', '69R', '70L', '71L', '72-', '73V', '74P', '75E', '76W', '77S',
           '78Y', '79I', '80M', '81E', '82-', '83E', '84N', '85P', '86R', '87-', '88-', '89L', '90C', '91Y', '92P',
           '93G', '94S', '95F', '96N', '97D', '98Y', '99E', '100E', '101L', '102K', '103H', '104L', '105L', '106S',
           '107S', '108V', '109-', '110H', '111F', '112E', '113K', '114V', '115K', '116I', '117L', '118P', '119-',
           '120D', '121-', '122W', '123T', '124Q', '125H', '126-', '127-', '128T', '129G', '130G', '131S', '132-',
           '133A', '134C', '135A', '136V', '137-', '138G', '139-', '140P', '141S', '142F', '143F', '144R', '145N',
           '146M', '147V', '148W', '149L', '150T', '151K', '152K', '153G', '154-', '155N', '156Y', '157P', '158V',
           '159A', '160K', '161-', '162S', '163Y', '164N', '165N', '166T', '167S', '168G', '169E', '170Q', '171M',
           '172L', '173-', '174I', '175W', '176G', '177V', '178H', '179H', '180P', '181N', '182D', '183E', '184A',
           '185E', '186Q', '187R', '188-', '189L', '190Y', '191Q', '192-', '193V', '194G', '195T', '196Y', '197V',
           '198S', '199-', '200-', '201T', '202S', '203-', '204L', '205N', '206K', '207R', '208S', '209-', '210P',
           '211E', '212I', '213A', '214-', '215R', '216P', '217-', '218V', '219-', '220-', '221-', '222G', '223G',
           '224R', '225M', '226E', '227F', '228S', '229W', '230T', '231-', '232L', '233-', '234-', '235L', '236D',
           '237T', '238I', '239-', '240F', '241E', '242S', '243T', '244G', '245N', '246L', '247V', '248A', '249P',
           '250E', '251Y', '252G', '253F', '254K', '255I', '256S', '257K', '258R', '259G', '260S', '261S', '262G',
           '263I', '264M', '265K', '266T', '267E', '268G', '269T', '270L', '271-', '272N', '273C', '274E', '275T',
           '276K', '277C', '278Q', '279T', '280P', '281L', '282G', '283A', '284I', '285N', '286T', '287T', '288L',
           '289P', '290F', '291H', '292N', '293-', '294H', '295P', '296L', '297T', '298I', '299G', '300E', '301C',
           '302P', '303K', '304Y', '305V', '306K', '307S', '308E', '309-', '310L', '311V', '312L', '313A', '314T',
           '315G', '316L', '317R', '318N', '319V', '320P', '321Q', '322I', '323E', '324S', '325R']}, 'HA2': {
    'H2': ['1G', '2L', '3F', '4G', '5A', '6I', '7A', '8G', '9F', '10I', '11E', '12G', '13G', '14W', '15Q', '16G', '17M',
           '18V', '19D', '20G', '21W', '22Y', '23G', '24Y', '25H', '26H', '27S', '28N', '29D', '30Q', '31G', '32S',
           '33G', '34Y', '35A', '36A', '37D', '38K', '39E', '40S', '41T', '42Q', '43K', '44A', '45-', '46D', '47-',
           '48I', '49T', '50N', '51K', '52V', '53N', '54S', '55V', '56I', '57E', '58K', '59M', '60N', '61T', '62Q',
           '63F', '64E', '65A', '66V', '67G', '68K', '69E', '70F', '71S', '72N', '73L', '74E', '75K', '76R', '77L',
           '78E', '79N', '80L', '81N', '82K', '83K', '84M', '85E', '86D', '87G', '88F', '89L', '90D', '91V', '92W',
           '93T', '94Y', '95N', '96A', '97E', '98L', '99L', '100V', '101L', '102M', '103E', '104N', '105E', '106R',
           '107T', '108L', '109D', '110F', '111H', '112D', '113S', '114N', '115V', '116K', '117N', '118L', '119Y',
           '120D', '121K', '122V', '123R', '124M', '125Q', '126L', '127R', '128D', '129N', '130-', '131K', '132E',
           '133L', '134G', '135N', '136G', '137C', '138F', '139E', '140F', '141Y', '142H', '143K', '144C', '145D',
           '146D', '147E', '148C', '149M', '150N', '151S', '152V', '153K', '154N', '155G', '156T', '157Y', '158D',
           '159Y', '160P', '161K', '162Y', '163E', '164E', '165E', '166S', '167K', '168L', '169-', '170R', '171N',
           '172E', '173I', '174K', '175G', '176V', '177K', '178L', '179-', '180-', '181M', '182G', '183V', '184Y',
           '185Q', '186I', '187L', '188A', '189I', '190Y', '191A', '192T', '193V', '194A', '195G', '196S', '197L',
           '198S', '199L', '200A', '201I', '202M', '203I', '204A', '205G', '206I', '207S', '208-', '209W', '210M',
           '211C', '212S', '213N', '214G', '215S', '216L', '217Q', '218C', '219R', '220I', '221C', '222I']}}
print(s["HA1"])
# marker_dict = {'M2': '41C'}
# for protein in list(marker_dict.keys()):
...
H3_dict = {-1: '9', 0: '10', 1: '11', 2: '12', 3: '13', 4: '14', 5: '15', 6: '16', 7: '17', 8: '18', 9: '19', 10: '20',
           ...
           44: '54', 45: '55', 46: '-', 47: '56', 48: '57', 49: '58', 50: '59', 51: '60', 52: '61', 53: '62', 54: '63',
           55: '64', 56: '65', 57: '66', 58: '67', 59: '68', 60: '69', 61: '70', 62: '71', 63: '72', 64: '73', 65: '74',
           66: '75', 67: '76', 68: '77', 69: '78', 70: '79', 71: '80', 72: '81', 73: '82', 74: '83', 75: '-', 76: '84',
           77: '85', 78: '86', 79: '87', 80: '88', 81: '89', 82: '90', 83: '91', 84: '92', 85: '93', 86: '94', 87: '95',
           88: '96', 89: '-', 90: '97', 91: '98', 92: '99', 93: '100', 94: '101', 95: '102', 96: '103', 97: '104',
           98: '105', 99: '106', 100: '107', 101: '108', 102: '109', 103: '110', 104: '111', 105: '112', 106: '113',
           107: '114', 108: '115', 109: '116', 110: '117', 111: '118', 112: '119', 113: '120', 114: '121', 115: '122',
           116: '123', 117: '124', 118: '125', 119: '-', 120: '-', 121: '126', 122: '127', 123: '128', 124: '129',
           125: '130', 126: '131', 127: '132', 128: '133', 129: '134', 130: '135', 131: '136', 132: '137', 133: '138',
           134: '139', 135: '140', 136: '141', 137: '142', 138: '143', 139: '144', 140: '145', 141: '146', 142: '147',
           143: '148', 144: '149', 145: '150', 146: '151', 147: '152', 148: '153', 149: '154', 150: '155', 151: '156',
           152: '157', 153: '158', 154: '159', 155: '160', 156: '161', 157: '162', 158: '163', 159: '164', 160: '165',
           161: '166', 162: '167', 163: '168', 164: '169', 165: '170', 166: '171', 167: '172', 168: '173', 169: '174',
           170: '175', 171: '176', 172: '177', 173: '178', 174: '179', 175: '180', 176: '181', 177: '182', 178: '183',
           179: '184', 180: '185', 181: '186', 182: '187', 183: '188', 184: '189', 185: '190', 186: '191', 187: '192',
           188: '193', 189: '194', 190: '195', 191: '196', 192: '197', 193: '198', 194: '199', 195: '200', 196: '201',
           197: '202', 198: '203', 199: '204', 200: '205', 201: '206', 202: '207', 203: '208', 204: '209', 205: '210',
           206: '211', 207: '212', 208: '213', 209: '214', 210: '215', 211: '216', 212: '217', 213: '218', 214: '219',
           215: '220', 216: '221', 217: '222', 218: '223', 219: '224', 220: '225', 221: '226', 222: '227', 223: '228',
           224: '229', 225: '230', 226: '231', 227: '232', 228: '233', 229: '234', 230: '235', 231: '236', 232: '237',
           233: '238', 234: '239', 235: '240', 236: '241', 237: '242', 238: '243', 239: '244', 240: '245', 241: '246',
           242: '247', 243: '248', 244: '249', 245: '250', 246: '251', 247: '252', 248: '253', 249: '254', 250: '255',
           251: '256', 252: '257', 253: '258', 254: '259', 255: '260', 256: '-', 257: '261', 258: '262', 259: '263',
           260: '264', 261: '265', 262: '266', 263: '267', 264: '268', 265: '269', 266: '270', 267: '271', 268: '272',
           269: '273', 270: '274', 271: '275', 272: '276', 273: '277', 274: '278', 275: '279', 276: '280', 277: '281',
           278: '282', 279: '283', 280: '284', 281: '285', 282: '286', 283: '287', 284: '288', 285: '289', 286: '290',
           287: '291', 288: '292', 289: '293', 290: '294', 291: '295', 292: '296', 293: '297', 294: '298', 295: '299',
           296: '300', 297: '301', 298: '302', 299: '303', 300: '304', 301: '305', 302: '306', 303: '307', 304: '308',
           305: '309', 306: '310', 307: '311', 308: '312', 309: '313', 310: '314', 311: '315', 312: '316', 313: '317',
           314: '318', 315: '319', 316: '320', 317: '321', 318: '322', 319: '323', 320: '324', 321: '325', 322: '326'}
def adjust_position_and_get_h3_position(marker, hatype, H3_dict, protein):
    # marker_match = re.fullmatch(r"(\d+)([A-Z]|-)", marker)
