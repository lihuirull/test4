...
#
# querySeqFile = "H6_standard_KJ200805.fas"  # 查询序列
# querySeqType = "nucleo"  # 查询序列类型
# mafftDir = "/home/think/mafft-7.158-without-extensions/scripts/"
# queryFileName = "H6_standard_KJ200805"
# file = open(queryFileName)
# querySeq = file.read()
# file.close()
# standardDBDir = "/home/think/18Mid/translatePerl/standard_seq/"
# standardDB = "H6"
#
# margeSeqAlignedSeq(querySeq,queryFileName,standardDBDir,standardDB,mafftDir)


# margeSeqAlignedSeq(outName+".fftns2", outFileDir)
# getAlignedSite(outName+".fftns2.out.fas",outFileDir)
