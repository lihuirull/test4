def MargeAlignedSeq(file="",dir=""):
    ...
    # QUERY_1_FIRST_LINE_NUM = n+3
    # RESULT_SEQ_NUM = count-7
    # RESULT_SEQ_NUM_PULS_QUERY_1 = count - 7 + 1

    # lineNum = 0
    # dictNameAndSeq = {}
    # order = 0
    # for eachName in seqName:
    #     order = order + 1
    #     dictNameAndSeq[eachName] = str(order)
    # print((dictNameAndSeq))
    # print(dictNameAndSeq["standard_L20407"])
    # tempSeq = dictNameAndSeq["standard_L20407"]
    # tempSeq = tempSeq+tempSeq
    # dictNameAndSeq["standard_L20407"] = tempSeq
    # print(dictNameAndSeq["standard_L20407"])
    ...
    # seqNumber = len(name)  # 包括Query_1的序列的个数
    # print(seqNameAndPos)
    # print("aaaaaaaaaaaaaaaaaaaaaaaaa",seqNumber,startPos)
